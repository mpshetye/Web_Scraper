...
const writeStream = fs.createWriteStream('scrap.csv');
//write header
writeStream.write(`Brand, Type, Price, Original Price, Discount \n`);
...
(async()=>{
  ...
  await axios(config)
    ...
    $("div._1xHGtK").each((index, element)=>{
        ...
        //write to CSV
        writeStream.write(`${comp}, ${name}, ${price}, ${originalPrice}, ${discount} \n`);
    });
